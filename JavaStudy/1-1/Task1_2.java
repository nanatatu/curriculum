...
public class Task1_2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("strArrayの２番目の要素は" + strArray[1] + "です。");
        /* ⑤下記の処理について、何をしているのかコメントを記入してください。
         *  [int型の配列 intArray の中に整数 10, 20, 30, 40, 50 の値が順に代入されています。]
         */
        int[] intArray = { 10, 20, 30, 40, 50 };

        // ⑥下記の処理について、何をしているのかコメントを記入してください。
        // [⑤で作成したint型配列intArrayの値を左から２番目と５番目の値を抽出して加算した結果を表示しています。]
