...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        final String reqEmpId = request.getParameter("empId").trim();	//trim:文字列から前後の空白を除去
        ...
        try {
        	...
        	//streamAPI
        	//getEmployeeListからstreamAPIのfindFirstメソッドで一番最初の要素を取得
        	//orElse:null以外も含まれている場合も含まれていない場合もあるコンテナオブジェクト
