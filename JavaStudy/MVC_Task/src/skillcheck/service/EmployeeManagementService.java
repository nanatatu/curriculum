...
public final class EmployeeManagementService extends BaseService implements EmployeeDao {
    ...
    private void executeSelectQuery(final ExecuteCase eCase, final List<EmployeeBean> pEmployeeBeanList)
        ...
        //StringBuilder:printlnと異なりヒープを圧迫しない
        ...
        try {
            ...
            case FIND_BY_EMPID:
                ...
                if (Objects.nonNull(emp)) {
                    ...
                    // [ここへ記述]
                    //*sbQuery内にSELECT_BASEのSQL文が入っている。
                    //*sbQueryはStringBuilderのインスタンスだから、toStringでString型にキャスト
                    ...
                    // [SQL:WHERE empId = ? AND deleteFlg = '0', 第一引数にidをセット]
                    ...
                    resultSet = preparedStatement.executeQuery(sbQuery.toString());
